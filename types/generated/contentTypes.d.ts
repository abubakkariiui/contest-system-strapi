...
export interface ApiContestParticipationContestParticipation
  extends Struct.CollectionTypeSchema {
  collectionName: 'contest_participations';
  info: {
    description: 'Tracks user progress, submissions, and scores for contests';
    displayName: 'Contest Participation';
    pluralName: 'contest-participations';
    singularName: 'contest-participation';
  };
  options: {
    draftAndPublish: false;
  };
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    responses: Schema.Attribute.JSON & Schema.Attribute.DefaultTo<[]>;
...
export interface ApiContestContest extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Configures contest metadata and access level';
    displayName: 'Contest';
    pluralName: 'contests';
  ...
  attributes: {
    accessLevel: Schema.Attribute.Enumeration<['normal', 'vip']> &
      Schema.Attribute.Required &
    ...
    prizeDescription: Schema.Attribute.Text;
    prizeTitle: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiQuestionQuestion extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Stores contest questions with answer metadata';
  ...
  attributes: {
    choices: Schema.Attribute.JSON & Schema.Attribute.DefaultTo<[]>;
    contest: Schema.Attribute.Relation<'manyToOne', 'api::contest.contest'>;
    correctAnswers: Schema.Attribute.JSON & Schema.Attribute.DefaultTo<[]>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    publishedAt: Schema.Attribute.DateTime;
    type: Schema.Attribute.Enumeration<['single', 'multi', 'boolean']> &
      Schema.Attribute.Required &
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::contest-participation.contest-participation': ApiContestParticipationContestParticipation;
